...
export const featuredProjects = [
  ...
  {
    title: "Omnbit",
    badge: "Secure Transaction Flows",
    description:
      "A backend-heavy product concept combining escrow mechanics, blockchain verification, payment orchestration, and security-focused service design.",
    architecture: [
...
export const youtubeHighlights = [
  ...
  "Backend engineering walkthroughs",
  "ML research explainers",
  "Live builds and visual engineering",
];
